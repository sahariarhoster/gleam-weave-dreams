...
const items = [
  ...
  { title: "Send Notice", url: "/notices", icon: BellRing, ownerOnly: true },
  ...
  { title: "Custom Site Integration", url: "/integrations", icon: Code2, anyRole: ["owner", "brand_owner", "support_agent"] as string[] },
  ...
  { title: "Credit Plan", url: "/credit-plan", icon: Package },
